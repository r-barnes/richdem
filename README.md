...
**Users are also encouraged to cite the particular algorithms used.** Citations
to these will be printed whenever an app, program, or library function is run.
Such citations are prefixed with the `C` tag. Although I have written all of the
code in this library, some of the algorithms were discovered or invented by
others, and they deserve credit for their good work.
