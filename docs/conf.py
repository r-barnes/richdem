...
latex_documents = [
  (master_doc, 'richdem.tex', 'RichDEM Documentation',
   'Richard Barnes', 'manual'),
]
...
man_pages = [
    (master_doc, 'richdem', 'RichDEM Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'richdem', 'RichDEM Documentation',
   author, 'richdem', 'TODO One line description of project.',
   'Miscellaneous'),
]
