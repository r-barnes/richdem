...
template<class elev_t, class accum_t> void FA_FairfieldLeymarie (const Array2D<elev_t> &elevations, Array2D<accum_t> &accum, const bool d4) {FlowAccumulation(FM_FairfieldLeymarie<elev_t>, elevations, accum, d4    ); }
