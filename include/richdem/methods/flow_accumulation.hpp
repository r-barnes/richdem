...
template<class elev_t, class accum_t> void FA_FairfieldLeymarieD8(const Array2D<elev_t> &elevations, Array2D<accum_t> &accum)                {FlowAccumulation(FM_FairfieldLeymarieD8<elev_t>, elevations, accum        ); }
template<class elev_t, class accum_t> void FA_FairfieldLeymarieD4(const Array2D<elev_t> &elevations, Array2D<accum_t> &accum)                {FlowAccumulation(FM_FairfieldLeymarieD4<elev_t>, elevations, accum        ); }
...
template<class elev_t, class accum_t> void FA_OCallaghanD8       (const Array2D<elev_t> &elevations, Array2D<accum_t> &accum)                {FlowAccumulation(FM_OCallaghanD8<elev_t>       , elevations, accum        ); }
template<class elev_t, class accum_t> void FA_OCallaghanD4       (const Array2D<elev_t> &elevations, Array2D<accum_t> &accum)                {FlowAccumulation(FM_OCallaghanD4<elev_t>       , elevations, accum        ); }
