...
template<class elev_t, class accum_t> void FA_FairfieldLeymarieD8(const Array2D<elev_t> &elevations, Array2D<accum_t> &accum, const bool d4) {FlowAccumulation(FM_FairfieldLeymarie<elev_t>, elevations, accum,       ); }
template<class elev_t, class accum_t> void FA_FairfieldLeymarieD4(const Array2D<elev_t> &elevations, Array2D<accum_t> &accum, const bool d4) {FlowAccumulation(FM_FairfieldLeymarie<elev_t>, elevations, accum,       ); }
...
template<class elev_t, class accum_t> void FA_OCallaghan         (const Array2D<elev_t> &elevations, Array2D<accum_t> &accum, const bool d4) {FlowAccumulation(FM_OCallaghan<elev_t>       , elevations, accum, d4    ); }
