...
template<class elev_t, class accum_t> void FA_FairfieldLeymarieD8(const Array2D<elev_t> &elevations, Array2D<accum_t> &accum)                { Array3D<float> props(elevations); FM_FairfieldLeymarieD8(elevations, props         );  FlowAccumulation(props, accum); }
template<class elev_t, class accum_t> void FA_FairfieldLeymarieD4(const Array2D<elev_t> &elevations, Array2D<accum_t> &accum)                { Array3D<float> props(elevations); FM_FairfieldLeymarieD4(elevations, props         );  FlowAccumulation(props, accum); }
...
template<class elev_t, class accum_t> void FA_OCallaghanD8       (const Array2D<elev_t> &elevations, Array2D<accum_t> &accum)                { Array3D<float> props(elevations); FM_OCallaghanD8       (elevations, props         );  FlowAccumulation(props, accum); }
template<class elev_t, class accum_t> void FA_OCallaghanD4       (const Array2D<elev_t> &elevations, Array2D<accum_t> &accum)                { Array3D<float> props(elevations); FM_OCallaghanD4       (elevations, props         );  FlowAccumulation(props, accum); }
