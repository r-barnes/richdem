...
const std::string algname  = "Barnes (2016) Parallel Priority-Flood";
const std::string citation = "Barnes, R., 2016. Parallel priority-flood depression filling for trillion cell digital elevation models on desktops or clusters. Computers & Geosciences 96, 56-68. doi:10.1016/j.cageo.2016.07.001";
