...
time mpirun -n 4 ./parallel_pit_fill.exe one @offloadall         ~/projects/watershed/data/beauford.tif /z/singlecore-

#Does block size make a difference?
time mpirun -n 4 ./parallel_pit_fill.exe one @offloadall         ~/projects/watershed/data/beauford.tif /z/a500block-   -w 500 -h 500 
time mpirun -n 4 ./parallel_pit_fill.exe one @offloadall         ~/projects/watershed/data/beauford.tif /z/b600block-   -w 600 -h 600 
...
time mpirun -n 50 ./parallel_pit_fill.exe one @retainall          ~/projects/watershed/data/beauford.tif /z/c500block-retain-  -w 500 -h 500 
time mpirun -n 4  ./parallel_pit_fill.exe one /z/retain/500block- ~/projects/watershed/data/beauford.tif /z/d500block-save-    -w 500 -h 500 
